...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspdd = new _jspdd2.default(srcData, newData);

	//从原始数据和变更数据，生成数据字典
	jspdd.descData = _jspdd2.default.generatorDict(JSON.parse((0, _stringify2.default)(srcData)), newData);
